...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'ciip_managerprofile', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], unique=True)),
            ('business_unit', self.gf('django.db.models.fields.CharField')(max_length=100, null=True)),
        ...
        db.send_create_signal(u'ciip', ['ManagerProfile'])

        # Adding model 'Message'
        db.create_table(u'ciip_message', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('text', self.gf('django.db.models.fields.TextField')(max_length=1000, null=True)),
            ('student', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ciip.UserProfile'])),
            ('manager', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ciip.ManagerProfile'])),
            ('sent_by', self.gf('django.db.models.fields.CharField')(max_length=50, null=True)),
            ('date_sent', self.gf('django.db.models.fields.DateTimeField')(null=True)),
        ))
        db.send_create_signal(u'ciip', ['Message'])

        # Adding model 'Interview'
        db.create_table(u'ciip_interview', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('date', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('student', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ciip.UserProfile'])),
            ('manager', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ciip.ManagerProfile'])),
            ('interview_response', self.gf('django.db.models.fields.CharField')(default=None, max_length=100, null=True)),
        ))
        db.send_create_signal(u'ciip', ['Interview'])


    def backwards(self, orm):
        # Deleting model 'ManagerProfile'
        db.delete_table(u'ciip_managerprofile')

        # Deleting model 'Message'
        db.delete_table(u'ciip_message')

        # Deleting model 'Interview'
        db.delete_table(u'ciip_interview')
    ...
    models = {
        ...
        u'ciip.managerprofile': {
            ...
            'business_unit': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True'}),
