...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.is_returning'
        db.add_column(u'ciip_userprofile', 'is_returning',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.is_returning'
        db.delete_column(u'ciip_userprofile', 'is_returning')
    ...
    models = {
        ...
        u'ciip.userprofile': {
            ...
            'is_returning': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'last_name': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True'}),
