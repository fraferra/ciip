...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.webex_link'
        db.add_column(u'ciip_userprofile', 'webex_link',
                      self.gf('django.db.models.fields.TextField')(max_length=200, null=True),
                      keep_default=False)

        # Adding field 'UserProfile.interview_response'
        db.add_column(u'ciip_userprofile', 'interview_response',
                      self.gf('django.db.models.fields.CharField')(default='None', max_length=100, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.webex_link'
        db.delete_column(u'ciip_userprofile', 'webex_link')

        # Deleting field 'UserProfile.interview_response'
        db.delete_column(u'ciip_userprofile', 'interview_response')
