...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.technical_resume_screen_selection'
        db.add_column('ciip_userprofile', 'technical_resume_screen_selection',
                      self.gf('django.db.models.fields.CharField')(default='---', max_length=30, null=True),
                      keep_default=False)

        # Adding field 'UserProfile.technical_resume_screen_comment'
        db.add_column('ciip_userprofile', 'technical_resume_screen_comment',
                      self.gf('django.db.models.fields.TextField')(max_length=1000, null=True),
                      keep_default=False)

        # Adding field 'UserProfile.technical_interview_screen_selection'
        db.add_column('ciip_userprofile', 'technical_interview_screen_selection',
                      self.gf('django.db.models.fields.CharField')(default='---', max_length=30, null=True),
                      keep_default=False)

        # Adding field 'UserProfile.technical_interview_screen_comment'
        db.add_column('ciip_userprofile', 'technical_interview_screen_comment',
                      self.gf('django.db.models.fields.TextField')(max_length=1000, null=True),
                      keep_default=False)

        # Adding field 'UserProfile.master_or_undergrad'
        db.add_column('ciip_userprofile', 'master_or_undergrad',
                      self.gf('django.db.models.fields.CharField')(default='---', max_length=30, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.technical_resume_screen_selection'
        db.delete_column('ciip_userprofile', 'technical_resume_screen_selection')

        # Deleting field 'UserProfile.technical_resume_screen_comment'
        db.delete_column('ciip_userprofile', 'technical_resume_screen_comment')

        # Deleting field 'UserProfile.technical_interview_screen_selection'
        db.delete_column('ciip_userprofile', 'technical_interview_screen_selection')

        # Deleting field 'UserProfile.technical_interview_screen_comment'
        db.delete_column('ciip_userprofile', 'technical_interview_screen_comment')

        # Deleting field 'UserProfile.master_or_undergrad'
        db.delete_column('ciip_userprofile', 'master_or_undergrad')
