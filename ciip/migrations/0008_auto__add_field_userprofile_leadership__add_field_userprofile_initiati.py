...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.leadership'
        db.add_column(u'ciip_userprofile', 'leadership',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=3, null=True),
                      keep_default=False)

        # Adding field 'UserProfile.initiative'
        db.add_column(u'ciip_userprofile', 'initiative',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=3, null=True),
                      keep_default=False)

        # Adding field 'UserProfile.innovation'
        db.add_column(u'ciip_userprofile', 'innovation',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=3, null=True),
                      keep_default=False)

        # Adding field 'UserProfile.adaptability'
        db.add_column(u'ciip_userprofile', 'adaptability',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=3, null=True),
                      keep_default=False)

        # Adding field 'UserProfile.team_player'
        db.add_column(u'ciip_userprofile', 'team_player',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=3, null=True),
                      keep_default=False)

        # Adding field 'UserProfile.cisco_fit'
        db.add_column(u'ciip_userprofile', 'cisco_fit',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=3, null=True),
                      keep_default=False)

        # Adding field 'UserProfile.technical_skill'
        db.add_column(u'ciip_userprofile', 'technical_skill',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=3, null=True),
                      keep_default=False)

        # Adding field 'UserProfile.motivation'
        db.add_column(u'ciip_userprofile', 'motivation',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=3, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.leadership'
        db.delete_column(u'ciip_userprofile', 'leadership')

        # Deleting field 'UserProfile.initiative'
        db.delete_column(u'ciip_userprofile', 'initiative')

        # Deleting field 'UserProfile.innovation'
        db.delete_column(u'ciip_userprofile', 'innovation')

        # Deleting field 'UserProfile.adaptability'
        db.delete_column(u'ciip_userprofile', 'adaptability')

        # Deleting field 'UserProfile.team_player'
        db.delete_column(u'ciip_userprofile', 'team_player')

        # Deleting field 'UserProfile.cisco_fit'
        db.delete_column(u'ciip_userprofile', 'cisco_fit')

        # Deleting field 'UserProfile.technical_skill'
        db.delete_column(u'ciip_userprofile', 'technical_skill')

        # Deleting field 'UserProfile.motivation'
        db.delete_column(u'ciip_userprofile', 'motivation')
