...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ManagerProfile.number_interns'
        db.alter_column(u'ciip_managerprofile', 'number_interns', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

    def backwards(self, orm):

        # Changing field 'ManagerProfile.number_interns'
        db.alter_column(u'ciip_managerprofile', 'number_interns', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=3, decimal_places=0))
