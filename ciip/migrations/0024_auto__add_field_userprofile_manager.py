...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'ciip_userprofile', 'manager',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['ciip.ManagerProfile'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.manager'
        db.delete_column(u'ciip_userprofile', 'manager_id')
