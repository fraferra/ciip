...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ManagerProfile.vap'
        db.add_column(u'ciip_managerprofile', 'vap',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=60, null=True),
                      keep_default=False)

        # Adding field 'ManagerProfile.number_interns'
        db.add_column(u'ciip_managerprofile', 'number_interns',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=3, decimal_places=0),
                      keep_default=False)

        # Adding field 'ManagerProfile.ds_7002'
        db.add_column(u'ciip_managerprofile', 'ds_7002',
                      self.gf('django.db.models.fields.files.FileField')(default=None, max_length=100, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ManagerProfile.vap'
        db.delete_column(u'ciip_managerprofile', 'vap')

        # Deleting field 'ManagerProfile.number_interns'
        db.delete_column(u'ciip_managerprofile', 'number_interns')

        # Deleting field 'ManagerProfile.ds_7002'
        db.delete_column(u'ciip_managerprofile', 'ds_7002')
    ...
    models = {
        ...
        u'ciip.managerprofile': {
            ...
            'number_interns': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '3', 'decimal_places': '0'}),
