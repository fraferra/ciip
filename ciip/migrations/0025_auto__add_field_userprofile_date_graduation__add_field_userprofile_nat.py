...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.date_graduation'
        db.add_column(u'ciip_userprofile', 'date_graduation',
                      self.gf('django.db.models.fields.DateField')(default=datetime.date.today),
                      keep_default=False)

        # Adding field 'UserProfile.nationality_1'
        db.add_column(u'ciip_userprofile', 'nationality_1',
                      self.gf('django.db.models.fields.CharField')(default='ZZ', max_length=2, null=True),
                      keep_default=False)

        # Adding field 'UserProfile.nationality_2'
        db.add_column(u'ciip_userprofile', 'nationality_2',
                      self.gf('django.db.models.fields.CharField')(default='ZZ', max_length=2, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.date_graduation'
        db.delete_column(u'ciip_userprofile', 'date_graduation')

        # Deleting field 'UserProfile.nationality_1'
        db.delete_column(u'ciip_userprofile', 'nationality_1')

        # Deleting field 'UserProfile.nationality_2'
        db.delete_column(u'ciip_userprofile', 'nationality_2')
