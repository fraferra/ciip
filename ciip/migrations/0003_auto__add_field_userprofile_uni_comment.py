...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.uni_comment'
        db.add_column(u'ciip_userprofile', 'uni_comment',
                      self.gf('django.db.models.fields.TextField')(max_length=500, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.uni_comment'
        db.delete_column(u'ciip_userprofile', 'uni_comment')
