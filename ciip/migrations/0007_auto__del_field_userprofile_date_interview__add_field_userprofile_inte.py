...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserProfile.date_interview'
        db.delete_column(u'ciip_userprofile', 'date_interview')

        # Adding field 'UserProfile.interviewer_comment'
        db.add_column(u'ciip_userprofile', 'interviewer_comment',
                      self.gf('django.db.models.fields.TextField')(default=None, max_length=1000, null=True),
                      keep_default=False)

        # Adding field 'UserProfile.interviewer_name'
        db.add_column(u'ciip_userprofile', 'interviewer_name',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=100, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'UserProfile.date_interview'
        db.add_column(u'ciip_userprofile', 'date_interview',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Deleting field 'UserProfile.interviewer_comment'
        db.delete_column(u'ciip_userprofile', 'interviewer_comment')

        # Deleting field 'UserProfile.interviewer_name'
        db.delete_column(u'ciip_userprofile', 'interviewer_name')
