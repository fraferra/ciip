...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ManagerProfile.number_employees_dept'
        db.add_column(u'ciip_managerprofile', 'number_employees_dept',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=20, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ManagerProfile.number_employees_dept'
        db.delete_column(u'ciip_managerprofile', 'number_employees_dept')
