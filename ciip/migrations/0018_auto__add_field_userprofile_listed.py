...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.listed'
        db.add_column(u'ciip_userprofile', 'listed',
                      self.gf('django.db.models.fields.TextField')(default='yes', max_length=50, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.listed'
        db.delete_column(u'ciip_userprofile', 'listed')
