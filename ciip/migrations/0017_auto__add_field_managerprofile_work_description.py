...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ManagerProfile.work_description'
        db.add_column(u'ciip_managerprofile', 'work_description',
                      self.gf('django.db.models.fields.TextField')(max_length=1000, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ManagerProfile.work_description'
        db.delete_column(u'ciip_managerprofile', 'work_description')
