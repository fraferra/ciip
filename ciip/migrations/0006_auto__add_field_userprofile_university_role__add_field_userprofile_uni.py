...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.university_role'
        db.add_column(u'ciip_userprofile', 'university_role',
                      self.gf('django.db.models.fields.CharField')(default='In consideration', max_length=100, null=True),
                      keep_default=False)

        # Adding field 'UserProfile.university_role_name'
        db.add_column(u'ciip_userprofile', 'university_role_name',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.university_role'
        db.delete_column(u'ciip_userprofile', 'university_role')

        # Deleting field 'UserProfile.university_role_name'
        db.delete_column(u'ciip_userprofile', 'university_role_name')
    ...
    models = {
        ...
        u'ciip.userprofile': {
            ...
            'university_role': ('django.db.models.fields.CharField', [], {'default': "'In consideration'", 'max_length': '100', 'null': 'True'}),
