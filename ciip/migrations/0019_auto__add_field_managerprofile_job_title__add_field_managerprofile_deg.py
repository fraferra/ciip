...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ManagerProfile.job_title'
        db.add_column(u'ciip_managerprofile', 'job_title',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=50, null=True),
                      keep_default=False)

        # Adding field 'ManagerProfile.degree'
        db.add_column(u'ciip_managerprofile', 'degree',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=50, null=True),
                      keep_default=False)

        # Adding field 'ManagerProfile.field'
        db.add_column(u'ciip_managerprofile', 'field',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=50, null=True),
                      keep_default=False)

        # Adding field 'ManagerProfile.group'
        db.add_column(u'ciip_managerprofile', 'group',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=50, null=True),
                      keep_default=False)

        # Adding field 'ManagerProfile.year_experience'
        db.add_column(u'ciip_managerprofile', 'year_experience',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=20, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ManagerProfile.job_title'
        db.delete_column(u'ciip_managerprofile', 'job_title')

        # Deleting field 'ManagerProfile.degree'
        db.delete_column(u'ciip_managerprofile', 'degree')

        # Deleting field 'ManagerProfile.field'
        db.delete_column(u'ciip_managerprofile', 'field')

        # Deleting field 'ManagerProfile.group'
        db.delete_column(u'ciip_managerprofile', 'group')

        # Deleting field 'ManagerProfile.year_experience'
        db.delete_column(u'ciip_managerprofile', 'year_experience')
