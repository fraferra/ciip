...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Search'
        db.create_table(u'ciip_search', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('manager', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ciip.ManagerProfile'])),
            ('search', self.gf('django.db.models.fields.CharField')(default=None, max_length=100, null=True)),
            ('ranking', self.gf('django.db.models.fields.CharField')(default=None, max_length=100, null=True)),
            ('offer_status', self.gf('django.db.models.fields.CharField')(default=None, max_length=100, null=True)),
            ('university', self.gf('django.db.models.fields.CharField')(default=None, max_length=100, null=True)),
            ('date', self.gf('django.db.models.fields.DateTimeField')(null=True)),
        ))
        db.send_create_signal(u'ciip', ['Search'])


    def backwards(self, orm):
        # Deleting model 'Search'
        db.delete_table(u'ciip_search')
