...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.offer_states'
        db.add_column(u'ciip_userprofile', 'offer_states',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=50, null=True),
                      keep_default=False)

        # Adding field 'UserProfile.manager_comment'
        db.add_column(u'ciip_userprofile', 'manager_comment',
                      self.gf('django.db.models.fields.TextField')(default=None, max_length=1000, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.offer_states'
        db.delete_column(u'ciip_userprofile', 'offer_states')

        # Deleting field 'UserProfile.manager_comment'
        db.delete_column(u'ciip_userprofile', 'manager_comment')
