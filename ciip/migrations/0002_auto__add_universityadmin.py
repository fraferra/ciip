...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UniversityAdmin'
        db.create_table(u'ciip_universityadmin', (
        ...
        db.send_create_signal(u'ciip', ['UniversityAdmin'])


    def backwards(self, orm):
        # Deleting model 'UniversityAdmin'
        db.delete_table(u'ciip_universityadmin')
