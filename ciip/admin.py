...
class CiipAdmin(admin.ModelAdmin):
    ...
    readonly_fields=['gender','passport', 'first_name','last_name','university','interview_response',
    #'date_interview',
...
class ManagerAdmin(admin.ModelAdmin):
    ...
    ('Interests and Skills', {'fields':['skill_1','skill_2','skill_3','interest_1','interest_2','interest_3']})]
